...
Test promotion simulations without affecting the database.
"""
import pytest
...
class TestSimulationHealthCheck:
    """Test simulation service health check"""
...
class TestSinglePromotionSimulation:
    """Test single promotion simulation endpoint"""

    def test_simulate_percentage_promotion(self, client: TestClient):
        """Test simulating a percentage discount promotion"""
        product_response = client.post("/products/", json={
            "sku": "SIM-PERCENT-001",
            "title": "Test Product for Simulation",
            "base_price": 1000.0,
            "stock": 100,
            "tax_rate": 18.0
        })
    ...
    def test_simulate_flat_discount_promotion(self, client: TestClient):
        """Test simulating a flat discount promotion"""
        product_response = client.post("/products/", json={
            "sku": "SIM-FLAT-001",
            "title": "Test Product for Flat Discount",
            "base_price": 2000.0,
            "stock": 50,
            "tax_rate": 10.0
        })
    ...
    def test_simulate_bogo_promotion(self, client: TestClient):
        """Test simulating a BOGO promotion"""
        product_response = client.post("/products/", json={
            "sku": "SIM-BOGO-001",
            "title": "Test Product for BOGO",
            "base_price": 500.0,
            "stock": 100,
            "tax_rate": 12.0
        })
    ...
    def test_simulate_promotion_with_min_quantity(self, client: TestClient):
        """Test simulating promotion with minimum quantity requirement"""
        product_response = client.post("/products/", json={
            "sku": "SIM-MINQTY-001",
            "title": "Test Product Min Qty",
            "base_price": 800.0,
            "stock": 100,
            "tax_rate": 18.0
        })
    ...
    def test_simulate_promotion_nonexistent_product(self, client: TestClient):
        """Test simulating promotion on non-existent product"""
        simulation_request = {
            "product_id": 99999,
            "quantity": 5,
            "test_promotion": {
...
class TestMultiplePromotionComparison:
    """Test multiple promotion comparison endpoint"""

    def test_compare_multiple_promotions(self, client: TestClient):
        """Test comparing multiple promotion options"""
        product_response = client.post("/products/", json={
            "sku": "SIM-MULTI-001",
            "title": "Test Product Multiple",
            "base_price": 2000.0,
            "stock": 100,
            "tax_rate": 18.0
        })
        ...
        comparison_request = {
            ...
            "test_promotions": [
                ...
                {
                    "name": "Option C: Buy 3 Get 1 Free",
                    "discount_type": "bogo",
                    "buy_quantity": 3,
                    "get_quantity": 1
                }
    ...
    def test_compare_two_promotions(self, client: TestClient):
        """Test comparing just two promotions"""
        product_response = client.post("/products/", json={
            "sku": "SIM-TWO-001",
            "title": "Test Product Two Options",
            "base_price": 1500.0,
            "stock": 50,
            "tax_rate": 12.0
        })
        ...
        comparison_request = {
            ...
            "test_promotions": [
                {
                    "name": "Option 1: 15% Off",
                    "discount_type": "percentage",
                    "discount_value": 15.0
                },
                {
                    "name": "Option 2: ₹200 Off",
                    "discount_type": "flat",
    ...
    def test_compare_promotions_nonexistent_product(self, client: TestClient):
        """Test comparing promotions on non-existent product"""
        comparison_request = {
            "product_id": 99999,
            "quantity": 5,
            "test_promotions": [
                {"name": "Test", "discount_type": "percentage", "discount_value": 10.0}
            ]
        }
...
class TestScenarioComparison:
    ...
    def test_compare_quantity_scenarios(self, client: TestClient):
        """Test comparing different quantity scenarios"""
        product_response = client.post("/products/", json={
            "sku": "SIM-SCEN-001",
            "title": "Test Product Scenarios",
            "base_price": 1000.0,
            "stock": 100,
            "tax_rate": 18.0
        })
        ...
        promotion_response = client.post("/promotions/", json={
        ...
        scenario_request = {
            ...
            "scenarios": [
                {
                    "description": "Buy 5 units",
                    "quantity": 5,
                    "currency": "INR"
                },
                {
                    "description": "Buy 10 units (bulk discount applies)",
                    "quantity": 10,
                    "currency": "INR"
                },
                {
                    "description": "Buy 20 units (bulk discount)",
                    "quantity": 20,
                    "currency": "INR"
                }
            ]
    ...
    def test_compare_currency_scenarios(self, client: TestClient):
        """Test comparing different currency scenarios"""
        product_response = client.post("/products/", json={
            "sku": "SIM-CURR-SCEN-001",
            "title": "Test Product Currency Scenarios",
            "base_price": 2000.0,
            "currency": "INR",
            "stock": 50,
            "tax_rate": 18.0
    ...
    def test_compare_single_scenario(self, client: TestClient):
        ...
        product_response = client.post("/products/", json={
            "sku": "SIM-SINGLE-SCEN-001",
            "title": "Test Single Scenario",
            "base_price": 1500.0,
            "stock": 50,
            "tax_rate": 10.0
        })
    ...
    def test_compare_scenarios_nonexistent_product(self, client: TestClient):
        """Test scenario comparison with non-existent product"""
        scenario_request = {
            "product_id": 99999,
            "scenarios": [
                {"description": "Test", "quantity": 5, "currency": "INR"}
            ]
        }
...
class TestSimulationIntegration:
    """Integration tests for simulation with existing promotions"""

    def test_simulation_with_existing_promotions(self, client: TestClient):
        """Test simulation when product already has active promotions"""
        product_response = client.post("/products/", json={
            "sku": "SIM-EXIST-001",
            "title": "Test Product With Existing Promo",
            "base_price": 3000.0,
            "stock": 100,
            "tax_rate": 18.0
        })
        ...
        existing_promo_response = client.post("/promotions/", json={
            "name": "Existing 10% Off",
            "discount_type": "percentage",
            "discount_value": 10.0,
            "start_date": datetime.utcnow().isoformat(),
            "end_date": (datetime.utcnow() + timedelta(days=7)).isoformat(),
    ...
    def test_simulation_does_not_save_to_database(self, client: TestClient):
        """Verify that simulation does not persist promotions to database"""
        product_response = client.post("/products/", json={
            "sku": "SIM-NOSAVE-001",
            "title": "Test No Save",
            "base_price": 1000.0,
